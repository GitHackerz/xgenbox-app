...
export default function BinAlert({ bin }: { bin: Bin }) {
  return (
    <div className="absolute bottom-0 right-0 p-4">
      ...
      >
        <div className="flex items-center">
          ...
          <h3 className="text-lg font-medium">Check BIN Level</h3>
        </div>
        <div className="mt-2 mb-4 text-sm">
          You&apos;re Bin is full, please check the level and empty it to avoid
          <br />
          Location: {bin.longitude}, {bin.latitude}
        </div>
        <div className="flex">
          <button
            type="button"
